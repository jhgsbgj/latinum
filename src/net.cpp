...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Latinum " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"latinumtools.com", "dnsseed.latinumtools.com"},
    {"latinumpool.org", "dnsseed.latinumpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"latinumtools.com", "testnet-seed.latinumtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Latinum is probably already running."), addrBind.ToString().c_str());
        else
